...
export default function LossReport(props) {
  ...
  const summit = () => {
    fetch('https://simnectzplatform.com:8080/simnectz_Bank-Credit_card_service-credit_card/creditcard/lossReporting', {
      method: 'POST',
      headers: {
        'accept': '*/*',
            ...
            <React.Fragment>
              ...
              <Grid container spacing={3}>
                <Dialog
                  ...
                  <DialogTitle id="alert-dialog-title">{"你确定挂失你的信用卡？"}</DialogTitle>
                  <DialogContent>
                    <DialogContentText id="alert-dialog-description">
                      挂失后你原本的信用卡将暂时冻结，请尽快到附近网点补办。
                    </DialogContentText>
                  </DialogContent>
                  <DialogActions>
